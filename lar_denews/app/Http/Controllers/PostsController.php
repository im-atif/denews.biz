...
class PostsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $featured->move('uploads/blog_images/', $featured_name);

        $post = Post::create([
            'title'         =>  $request->title,
            'content'       =>  $request->blog_desc,
            'featured'      =>  'uploads/blog_images/' . $featured_name,
        ...
        Session::flash('success', 'Your have successfully added a new post.');
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->hasFile('featured'))
        {
            ...
            $post->featured = 'uploads/blog_images/' . $featured_name;
        }

        $post->title = $request->title;
        $post->category_id  = $request->category_id;
        $post->content = $request->blog_desc;

        $post->save();

        $post->tags()->sync($request->tags);

        Session::flash('success', 'Your post has been successfully updated.');
    ...
    public function kill($id)
    {
        ...
        Session::flash('success', 'The post has be deleted successfully');
        return redirect()->back();
    }
